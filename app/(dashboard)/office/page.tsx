...
const INITIAL_AGENTS: Agent[] = [
  { id: "1", name: "Henry",  avatar: "🧑‍💼", color: "#f97316", status: "working",  task: "Build Council — Sprint Plan", deskPosition: { row: 0, col: 0 }, currentPosition: { row: 0, col: 0 } },
  { id: "2", name: "Nox",    avatar: "🤖",   color: "#8b5cf6", status: "working",  task: "Office View — Isometric UI",  deskPosition: { row: 0, col: 1 }, currentPosition: { row: 0, col: 1 } },
  { id: "3", name: "Alex",   avatar: "👩‍🔬", color: "#ec4899", status: "chatting", task: "API Design Review",           deskPosition: { row: 0, col: 2 }, currentPosition: { row: 0, col: 2 } },
  { id: "4", name: "Quill",  avatar: "✍️",   color: "#14b8a6", status: "working",  task: "Documentation Update",        deskPosition: { row: 0, col: 3 }, currentPosition: { row: 0, col: 3 } },
  { id: "5", name: "Echo",   avatar: "🔊",   color: "#f59e0b", status: "idle",     task: "Awaiting instructions",       deskPosition: { row: 1, col: 0 }, currentPosition: { row: 1, col: 0 } },
  { id: "6", name: "Scout",  avatar: "🔍",   color: "#06b6d4", status: "working",  task: "Security Audit — Auth",       deskPosition: { row: 1, col: 1 }, currentPosition: { row: 1, col: 1 } },
  { id: "7", name: "Codex",  avatar: "📖",   color: "#a855f7", status: "working",  task: "Code Review — PR #42",        deskPosition: { row: 1, col: 2 }, currentPosition: { row: 1, col: 2 } },
  { id: "8", name: "Pixel",  avatar: "🎨",   color: "#10b981", status: "walking",  task: "UI Component Library",        deskPosition: { row: 1, col: 3 }, currentPosition: { row: 1, col: 3 } },
];
...
export default function OfficePage() {
  ...
  function pushActivity(agent: string, action: string) {
    setActivities((prev) =>
      [{ id: crypto.randomUUID(), agent, action, timestamp: new Date() }, ...prev].slice(0, 50)
    );
  }
